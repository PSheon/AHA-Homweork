    ...
    return (
      <Html lang='en'>
        <Head>
          ...
          <meta name='apple-mobile-web-app-title' content='PSheon' />
          <meta name='application-name' content='PSheon' />
          <meta name='msapplication-TileColor' content='#282a42' />
          <meta name='theme-color' content='#282a42'></meta>
        </Head>
        <body>
          <Main />
          <NextScript />
