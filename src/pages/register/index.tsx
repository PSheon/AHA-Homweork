...
const Register = () => {
  ...
  const imageSource = skin === 'bordered' ? 'auth-register-illustration-bordered' : 'auth-register-illustration'
    ...
    <Box className='content-right'>
      {!hidden ? (
        <Box sx={{ flex: 1, display: 'flex', position: 'relative', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <FooterIllustrations image={`/images/pages/auth-register-mask-${theme.palette.mode}.png`} />
        </Box>
      ) : null}
